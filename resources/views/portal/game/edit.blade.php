                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" id="close_date" name="close_date" class="form-control" placeholder="Close Date" required value="{{$game->close_date}}">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="time" id="game_time" name="game_time" class="form-control" placeholder="Game Time" required value="{{$game->game_time}}">
